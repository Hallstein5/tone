...
contract NFTTONE is Context, IERC20, Ownable {
    ...
    uint256 public _BurnCharityFee   = 0;
    address public BurnCharityWallet = 0x7443401996D3f05da65BdA55E62713fb7ced43B5;
    uint256 private _previousBurnCharityFee = _BurnCharityFee;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 BurnCharityAmt = amount.mul(_BurnCharityFee).div(100);
        ...
        _transferStandard(sender, BurnCharityWallet, BurnCharityAmt);
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _BurnCharityFee   = 4;
        _previousBurnCharityFee = _BurnCharityFee;
        _burnFee      = 0;
    ...
    function setBurnCharityWallet(address newWallet) external onlyOwner() {
        BurnCharityWallet = newWallet;
    }
